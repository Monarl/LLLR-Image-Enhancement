...
class MobileViT_Backbone(nn.Module):
    def __init__(self, image_size=(256,256), dims=[144, 192, 240], 
        ...
        self.mv2 = nn.ModuleList([
            ...
            MV2Block(channels[3], channels[3], 1, expansion), 
        ...
        # Lưu lại output channels của 5 scale để lát nữa MambaIRv2 biết đường project
        self.out_channels = [channels[1], channels[3], channels[5], channels[7], channels[-1]]
...
def mobilevit_s_backbone():
    dims = [144, 192, 240]
    channels = [16, 32, 64, 64, 96, 96, 128, 128, 160, 160, 640]
    return MobileViT_Backbone((256, 256), dims, channels)
